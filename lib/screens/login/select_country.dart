...
class _SelectCountryState extends State<SelectCountry> {
  List<dynamic>? dataRetrived; //for the data decoded from the json file
  List<dynamic>? data; //for the data diplay on the screen
    ...
    return CupertinoPageScaffold(
      child: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: CupertinoSearchTextField(
            onChanged: (value) {
              setState(() {
                searchValue = value;
              });
          ...
          SliverList(
            delegate: SliverChildListDelegate((data != null)
                ? data!.where((e) => e['name'].toString().toLowerCase().contains(searchValue.toLowerCase()))
